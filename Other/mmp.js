...
function __yx_SetMainPlayIFrameSRC(_in_id, cb_getplay_url) {
	...
	if (dettchk()) {
		$.get(_getplay_url, function(_in_data, _in_status) {
			...
			window._in_data = _in_data;
      console.log(_in_data);
      document.getElementById("play_imform").innerHTML+='<li class="play_imform_kv" id="lalala"> <span class="play_imform_tag">获取状态：</span> <span class="play_imform_val" style="color:red;">成功</span></li>';
